...
func (s *Svc) CreateParkingLotValidation(ctx context.Context, req *plpb.CreateParkingLotRequest) error {
	log := logging.FromContext(ctx).WithField("method", "Service.CreateParkingLotValidation")
